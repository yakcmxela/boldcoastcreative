	...
	<div class="container py-m">
		...
		<div class="row py-5 section-text">
			<div class="col-lg-4 py-2">
				...
				<p>Bold Coast Creative uses a hands-on approach. First, I will meet with you to learn about your business. With an understanding of your goals and budget, I will propose a plan catered to your needs. We will then get to work building, communicating and providing you with working drafts along the way. You will have full access to the project as it evolves into a final working product.</p>
			</div>
			<div class="col-lg-4 py-2" id="pricing">
