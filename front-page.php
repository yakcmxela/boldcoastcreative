...
<!-- Style and Design -->
	...
	<div class="img-desktop-container">
		<div class="text-cliff">
			<h1 style="font-family: 'Work Sans', sans-serif;">BOLD</h1>
			<h3><span>Styles &amp; <a href="/design/">Designs</a></span></h3>
		</div>
		<img class="img-desktop" src="<?php echo $lpCliff['url']; ?>">
		<img id="lp-bold" src="<?php echo $lpBold['url']; ?>">
		<img id="lp-water" src="<?php echo $lpWater['url']; ?>">
		<img id="lp-text" src="<?php echo $lpText['url']; ?>">
	</div>
...
<!-- Photography -->
	...
	<div class="container-fluid lp-gallery p-xl">
		<div class="row no-gutters">
			<div class="col-12 no-p lp-gallery-img center-center eff-gold" style="background-image: url('<?php echo $photography4['url']; ?>');">
			</div> 

			<div class="col-12 no-p lp-gallery-img bottom-center eff-gold" style="background-image: url('<?php echo $photography1['url']; ?>');">
				<div class="lp-gallery-txt">
					<h2><a href="design-media/"><span>Exceptional Image Quality</span></a></h2>
				</div>
			</div> 
